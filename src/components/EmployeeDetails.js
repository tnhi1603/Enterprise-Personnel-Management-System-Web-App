...
function EmployeeDetail() {
            ...
            axios.get(`http://localhost:3001/api/employee/${employeeId}`)
                .then(response => {
                    ...
                    setFormData({
                        ...
                        DayOfBirth: data.DayOfBirth ? data.DayOfBirth.split('T')[0] : '',
    ...
    const handleCancel = () => {
        ...
        setFormData({
            ...
            DayOfBirth: employee.DayOfBirth ? employee.DayOfBirth.split('T')[0] : '',
                ...
                isEditing ? (
                    <div>
                        ...
                        <form>
                            ...
                            <label>
                                Date of Birth:
                                <input type="date" name="DayOfBirth" value={formData.DayOfBirth} onChange={handleChange} />
                            </label>
                            <label>
                                Department ID:
                            ...
                            <label>
                                Reminder ID:
                                <input type="text" name="ReminderID" value={formData.ReminderID} onChange={handleChange} />
                            </label>
                            <label>
                                Gender:
                    ...
                    <div>
                        ...
                        <p><strong>Date of Birth:</strong> {employee.DayOfBirth.split('T')[0]}</p>
